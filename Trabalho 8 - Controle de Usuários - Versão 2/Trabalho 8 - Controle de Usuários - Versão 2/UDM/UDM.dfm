object DM: TDM
  ...
  object QUserTela: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select rel.idUsuario, rel.idTela, rel.inserir, rel.alterar, rel.' +
        'excluir, rel.imprimir, t.name, t.descricao from tela t, rel_usua' +
        'rio_tela rel where t.id = rel.idTela and rel.idUsuario = :id')
    Left = 152
    Top = 288
  end
  ...
  object MUserTela: TClientDataSet
    ...
    object MUserTelainserir: TBooleanField
      FieldName = 'inserir'
    end
    object MUserTelaalterar: TBooleanField
      FieldName = 'alterar'
    end
    object MUserTelaexcluir: TBooleanField
      FieldName = 'excluir'
    end
    object MUserTelaimprimir: TBooleanField
      FieldName = 'imprimir'
    end
  end
  ...
  object QPermissoes: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select rel.idUsuario, rel.idTela, t.name, rel.inserir, rel.alter' +
        'ar, rel.excluir, rel.imprimir from tela t, rel_usuario_tela rel ' +
        'where t.id = rel.idTela and rel.idUsuario = :id')
    Left = 152
    Top = 488
  end
  ...
  object MPermissoes: TClientDataSet
    ...
    object MPermissoesinserir: TBooleanField
      FieldName = 'inserir'
    end
    object MPermissoesalterar: TBooleanField
      FieldName = 'alterar'
    end
    object MPermissoesexcluir: TBooleanField
      FieldName = 'excluir'
    end
    object MPermissoesimprimir: TBooleanField
      FieldName = 'imprimir'
    end
  end
