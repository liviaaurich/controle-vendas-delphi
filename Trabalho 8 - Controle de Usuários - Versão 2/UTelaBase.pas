...
begin
  ...
  btnNovo.Enabled      := not(DSDataSet.DataSet.State in dsEditModes);
  btnEditar.Enabled    := not(DSDataSet.DataSet.State in dsEditModes) and not(DSDataSet.DataSet.IsEmpty);
  btnSalvar.Enabled    := (DSDataSet.DataSet.State in dsEditModes);
  ...
  btnExcluir.Enabled   := not(DSDataSet.DataSet.State in dsEditModes) and not(DSDataSet.DataSet.IsEmpty);
  btnImprimir.Enabled  := not(DSDataSet.DataSet.State in dsEditModes);
